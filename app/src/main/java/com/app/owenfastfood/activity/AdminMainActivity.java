...
import com.app.owenfastfood.adapter.AdminViewPagerAdapter;
import com.app.owenfastfood.databinding.ActivityAdminMainBinding;
...
public class AdminMainActivity extends BaseActivity {
    ...
    private void showConfirmExitApp() {
        new MaterialDialog.Builder(this).title(getString(R.string.app_name)).content(getString(R.string.ms_exit_app)).positiveText(getString(R.string.action_ok)).onPositive((dialog, which) -> finishAffinity()).negativeText(getString(R.string.action_cancel)).cancelable(false).show();
    }
