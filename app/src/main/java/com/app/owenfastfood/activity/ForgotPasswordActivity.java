...
import com.app.owenfastfood.databinding.ActivityForgotPasswordBinding;
...
public class ForgotPasswordActivity extends BaseActivity {
    ...
    private void onClickValidateResetPassword() {
        ...
        if (StringUtil.isEmpty(strEmail)) {
            Toast.makeText(ForgotPasswordActivity.this, getString(R.string.ms_email_require), Toast.LENGTH_SHORT).show();
        } else if (!StringUtil.isValidEmail(strEmail)) {
            Toast.makeText(ForgotPasswordActivity.this, getString(R.string.ms_email_invalid), Toast.LENGTH_SHORT).show();
        } else {
        ...
        auth.sendPasswordResetEmail(email).addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        Toast.makeText(ForgotPasswordActivity.this,
                                getString(R.string.ms_reset_password_success),
