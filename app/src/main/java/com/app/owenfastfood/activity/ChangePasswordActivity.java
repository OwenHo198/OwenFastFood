...
import com.app.owenfastfood.databinding.ActivityChangePasswordBinding;
...
public class ChangePasswordActivity extends BaseActivity {
    ...
    private void onClickValidateChangePassword() {
        ...
        if (StringUtil.isEmpty(strOldPassword)) {
            Toast.makeText(ChangePasswordActivity.this, getString(R.string.ms_old_password_require), Toast.LENGTH_SHORT).show();
        } else if (StringUtil.isEmpty(strNewPassword)) {
            Toast.makeText(ChangePasswordActivity.this, getString(R.string.ms_new_password_require), Toast.LENGTH_SHORT).show();
        } else if (StringUtil.isEmpty(strConfirmPassword)) {
            Toast.makeText(ChangePasswordActivity.this, getString(R.string.ms_confirm_password_require), Toast.LENGTH_SHORT).show();
        } else if (!DataStoreManager.getUser().getPassword().equals(strOldPassword)) {
            Toast.makeText(ChangePasswordActivity.this, getString(R.string.ms_old_password_invalid), Toast.LENGTH_SHORT).show();
        } else if (!strNewPassword.equals(strConfirmPassword)) {
            Toast.makeText(ChangePasswordActivity.this, getString(R.string.ms_confirm_password_invalid), Toast.LENGTH_SHORT).show();
        } else if (strOldPassword.equals(strNewPassword)) {
            Toast.makeText(ChangePasswordActivity.this, getString(R.string.ms_new_password_invalid), Toast.LENGTH_SHORT).show();
        } else {
        ...
        user.updatePassword(newPassword).addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        Toast.makeText(ChangePasswordActivity.this,
                                getString(R.string.ms_change_password_success), Toast.LENGTH_SHORT).show();
                        ...
                        GlobalFunction.gotoAccount(this);
                        finishAffinity();
                    }
                    else {
                        Toast.makeText(ChangePasswordActivity.this, getString(R.string.ms_change_password_error),
