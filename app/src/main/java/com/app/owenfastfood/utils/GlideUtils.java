...
public class GlideUtils {
    ...
    public static void loadUrlBanner(String url, ImageView imageView) {
        ...
        Glide.with(imageView.getContext()).load(url).error(R.drawable.img_no_image).dontAnimate().into(imageView);
    }
    ...
    public static void loadUrl(String url, ImageView imageView) {
        ...
        Glide.with(imageView.getContext()).load(url).error(R.drawable.image_no_available).dontAnimate().into(imageView);
    }
}